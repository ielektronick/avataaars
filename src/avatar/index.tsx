...
const Avatar = ({ avatarStyle, className, style }: AvatarProps) => {
  ...
  return (
    <svg
      ...
      <defs>
        <circle id={path1.current} cx='120' cy='120' r='120' />
        <path
          ...
          <g transform='translate(825.000000, 1100.000000)'>
            ...
            <g
              ...
              <g id='Body' transform='translate(32.000000, 36.000000)'>
                ...
                <use fill='#D0C6AC' xlinkHref={'#' + path3.current} />
                <Skin maskID={mask3.current} />
                <path
