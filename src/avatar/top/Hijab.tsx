...
const Hijab = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Accesories/Hijab' mask={`url(#${mask1.current})`}>
        <g transform='translate(-1.000000, 0.000000)'>
          ...
          />
          <HatColor maskID={mask2.current} defaultColor='Blue03' />
          <path
