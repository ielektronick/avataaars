...
const Turban = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Accesories/Turban' mask={`url(#${mask1.current})`}>
        <g transform='translate(-1.000000, 0.000000)'>
          ...
          <g
            ...
            <g transform='translate(48.000000, 3.000000)'>
              ...
              />
              <HatColor maskID={mask3.current} defaultColor='Blue03' />
            </g>
            <path
...
Turban.optionValue = Turban.name
