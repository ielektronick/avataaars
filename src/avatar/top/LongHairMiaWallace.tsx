...
const LongHairMiaWallace = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Long-Hair/Mia-Wallace' mask={`url(#${mask1.current})`}>
...
LongHairMiaWallace.optionValue = LongHairMiaWallace.name
