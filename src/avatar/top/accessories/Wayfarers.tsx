...
const Wayfarers = () => {
  ...
  const linearGradient1 = useRef(uniqueId('react-linear-gradient-'))
      ...
      <g
        ...
        <g
          ...
          <g id='Shade'>
            ...
            />
            <use
              fill={`url(#${linearGradient1.current})`}
              fillRule='evenodd'
...
Wayfarers.optionValue = Wayfarers.name
