...
const LongHairStraight = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Long-Hair/Straight' mask={`url(#${mask1.current})`}>
...
LongHairStraight.optionValue = LongHairStraight.name
