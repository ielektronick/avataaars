...
const ShortHairShortWaved = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Short-Hair/Short-Waved' mask={`url(#${mask2.current})`}>
...
ShortHairShortWaved.optionValue = ShortHairShortWaved.name
