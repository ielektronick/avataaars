...
const WinterHat2 = ({ children }: PropsWithChildren<unknown>) => {
    ...
    <g id='Top'>
      ...
      <g
        ...
        <g
          ...
          />
          <HatColor maskID={mask2.current} defaultColor='Blue01' />
          <rect
            id='color-dark'
            fillOpacity='0.2'
            fill='#000000'
...
WinterHat2.optionValue = WinterHat2.name
