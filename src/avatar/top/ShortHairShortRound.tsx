...
const ShortHairShortRound = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Short-Hair/Short-Round' mask={`url(#${mask2.current})`}>
...
ShortHairShortRound.optionValue = ShortHairShortRound.name
