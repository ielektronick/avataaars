...
const ShortHairShaggy = ({ children }: PropsWithChildren<unknown>) => {
  ...
  return (
    <g id='Top' strokeWidth='1' fillRule='evenodd'>
      ...
      <g id='Mask' />
      <g id='Top/Short-Hair/Shaggy' mask={`url(#${mask2.current})`}>
        <g transform='translate(-1.000000, 0.000000)'>
          <FacialHair />
          {children}
          <mask id={mask1.current} fill='white'>
            <use xlinkHref={'#' + path1.current} transform='scale(-1, 1)' />
          </mask>
...
ShortHairShaggy.optionValue = ShortHairShaggy.name
