...
const WinterHat4 = ({ children }: PropsWithChildren<unknown>) => {
  ...
  const mask4 = useRef(uniqueId('react-mask-'))
  const path1 = useRef(uniqueId('react-path-'))
  const path2 = useRef(uniqueId('react-path-'))
  const path3 = useRef(uniqueId('react-path-'))
  const path4 = useRef(uniqueId('react-path-'))
  const path5 = useRef(uniqueId('react-path-'))

  return (
    <g id='Top'>
      <defs>
        <rect id={path5.current} x='0' y='0' width='264' height='280' />
        <path
      ...
      <g
        ...
        <g
          ...
          <mask id={mask3.current} fill='white'>
          ...
          />
          <mask id={mask4.current} fill='white'>
        ...
        <g id='hat-front'>
          <use
            fill='black'
            fillOpacity='1'
            filter={`url(#${path4.current})`}
            xlinkHref={'#' + path4.current}
          />
          <use
            fill='#F4F4F4'
            fillRule='evenodd'
...
WinterHat4.optionValue = WinterHat4.name
