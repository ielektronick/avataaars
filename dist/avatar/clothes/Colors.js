...
const makeColor = (name, color) => {
    const ColorComponent = ({ maskID }) => (_jsx("g", { id: 'Color/Palette/Gray-01', mask: `url(#${maskID})`, fillRule: 'evenodd', fill: color, children: _jsx("rect", { id: '\uD83D\uDD8DColor', x: '0', y: '0', width: '264', height: '110' }) }));
