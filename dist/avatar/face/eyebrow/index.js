...
const Eyebrow = () => (_jsxs(Selector, { defaultOption: Default, option: EyebrowOption, children: [_jsx(Angry, {}), _jsx(AngryNatural, {}), _jsx(Default, {}), _jsx(DefaultNatural, {}), _jsx(FlatNatural, {}), _jsx(RaisedExcited, {}), _jsx(RaisedExcitedNatural, {}), _jsx(SadConcerned, {}), _jsx(SadConcernedNatural, {}), _jsx(UnibrowNatural, {}), _jsx(UpDown, {}), _jsx(UpDownNatural, {})] }));
